...
const CustomerShareForm = (props: any) => {
                ...
                <div className="orderTable">
                  <table className="table">
                    ...
                    <tr>
                      ...
                      <td>{moment(cifInfo?.eventDate).format("DD/MM/YYYY")}</td>
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                <EmailShareButton
                  ...
                  onClick={() => {
                    const emailBody =
                      encodeURIComponent(`Hello ${cifInfo?.firstName},
    Thank you for the opportunity to serve you . Please click the link below for your inquiry:
