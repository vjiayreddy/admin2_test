...
import PoonapantMeasurments from "./poonapantMeasurements";
        ...
        <div style={{ flexGrow: 1 }}>
          ...
          {measurments && (
            <Fragment>
              ...
              {catId === "5da7220571762c2a58b27a66" && (
                <SuitMeasurements measurments={measurments} />
              )}
              {catId === "6036451627e32d7fd776a580" && (
                <DhotiMeasurments measurments={measurments} />
              )}
              {catId === "6036446927e32d7fd776a57f" && (
                <ChudidarMeasurments measurments={measurments} />
              )}
              {catId === "5ebb993abcb3d23714b2ebf4" && (
                <ShoesMeasurments measurments={measurments} />
              )}
              {catId === "5da7220571762c2a58b27a73" && (
                <JootisMeasurments measurments={measurments} />
              )}
              {catId === "621a34485417ab1e143a5245" && (
                <PatiyalaMeasurments measurments={measurments} />
              )}
              {catId === "5da7220571762c2a58b27a72" && (
                <PagdiMeasurments measurments={measurments} />
              )}
               {catId === "636f3012feea0816508c5c45" && (
